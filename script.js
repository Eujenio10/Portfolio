...
function addTerminalEffect() {
    ...
    if (heroTitle) {
        ...
        heroTitle.innerHTML = '<span class="terminal-prompt">$ </span>' + heroTitle.innerHTML;
    }
}
...
// Gestione del form di contatto - RIMOSSO per permettere l'invio reale
// Il form ora invierà direttamente a Formspree senza interferenze JavaScript
